        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#" class="active">Contact<span class="sr-only">(current)</span></a></li>                    
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <lable name="subject">subject:</label>
                        <input id="name" name="subject" class="form-control">
                    </div>
                    <div class="form-group">
                        <lable name="Message">Message:</label>
                        <textarea id="name" name="Message" class="form-control">Type your text here ...</textarea>
                    </div>
